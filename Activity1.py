...
class RestaurantOrderManagement:
    ...
    def __init__ (self, root):
        ...
        self.menu_quantities = {} # To store references to quantitiy entry widgets
        ...
        for i, (item, price) in enumerate(self.menu_items(), start = 1):
            ...
            quantity_entry = ttk.Enrty(frame, width = 5)
        ...
        # Dropdown for currency selections
    ...
    def setup_background(self, root):
        ...
        canvas.create_image(0, 0, anchor = tk.NW, image = background.image)
...
# CODE DOES NOT WORK ON VSC, GO TO REPLIT > TKINTER TO RUN